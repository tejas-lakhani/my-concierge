...
import { createTermsAndCondition } from "../../../redux/slices/appPageSlice/termsAndConditionsSlice";
  ...
  return (
    <div className="bg-white py-4 px-[50px]">
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-2xl font-semibold">Create Terms and Condition</h1>
      </div>
