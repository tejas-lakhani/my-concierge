...
import { Avatar, Button, IconButton, Menu, MenuItem, TextField, Tooltip } from "@mui/material";
...
const contacts = [
  ...
  { id: 2, name: "Jonathan Benitez", avatarSrc: "https://via.placeholder.com/150" },
  { id: 3, name: "Christien Kelly", avatarSrc: "https://via.placeholder.com/150" }
];
...
const chatMessages = {
  1: [
    ...
    { sender: "Aya Mason", message: "How are you?", time: "8.31pm", self: false },
    { sender: "You", message: "Hello!", time: "8.33pm", self: true },
    { sender: "You", message: "I am fine and how are you?", time: "8.34pm", self: true },
    { sender: "Aya Mason", message: "I am doing well, Can we meet tomorrow?", time: "8.36pm", self: false },
    { sender: "You", message: "Yes Sure!", time: "8.58pm", self: true },
  ],
  2: [
    { sender: "Jonathan Benitez", message: "Hello!", time: "9.10pm", self: false },
    { sender: "You", message: "Hey, how’s it going?", time: "9.15pm", self: true },
  ],
  3: [
    { sender: "Christien Kelly", message: "Can you send the files?", time: "3.00pm", self: false },
    { sender: "You", message: "Sure, I’ll send them shortly.", time: "3.05pm", self: true },
  ],
};
    ...
    <div className="bg-white p-9">
      ...
      <div className="flex flex-col sm:flex-row gap-5">
        ...
        <div>
          ...
          >
            <MenuItem onClick={handleCloseMembershipMenu}>Membership 1</MenuItem>
            <MenuItem onClick={handleCloseMembershipMenu}>Membership 2</MenuItem>
          </Menu>
        </div>
      </div>
            ...
            <>
              ...
              <div className="flex items-center justify-between p-4 border-b">
                <div className="flex items-center">
                  <Avatar alt={contacts[selectedContact - 1].name} src={contacts[selectedContact - 1].avatarSrc} />
                  <h4 className="ml-4 text-lg font-medium">{contacts[selectedContact - 1].name}</h4>
                </div>
                <IconButton>
                  <MoreVertIcon />
                </IconButton>
              ...
              <div className="h-[48vh] flex-grow p-4 space-y-3 overflow-y-auto">
                {chatMessages[selectedContact].map((msg, index) => (
                  ...
                  >
                    <div
                      className={`${msg.self ? 'bg-gray-300' : 'bg-gray-200'
